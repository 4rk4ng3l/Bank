                                    ...
                                    <thead>
                                        <tr role="row">
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                ...
                                                style="width: 50px;">Id Transferencia
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                    ...
                                    <tbody>
                                        @foreach ($transferencias as $transferencia)
                                            <tr class="odd">
                                                ...
                                                <td class="">{{ $transferencia->usuarioOrigen }}</td>
                                                <td class="">{{ $transferencia->cuentaOrigen }}</td>
                                                <td class="">{{ $transferencia->usuarioDestino }}</td>
                                                <td class="">{{ $transferencia->cuentaDestino }}</td>
